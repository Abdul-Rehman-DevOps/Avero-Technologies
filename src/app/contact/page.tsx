...
export const metadata = buildMetadata({
  title: "Talk to us",
  description: "Reach Avero Technologies with a question or project discussion. We reply with a clear next step.",
  path: "/contact",
});
  ...
  return (
    <>
      <PageHero
        ...
        label="Talk to us"
        title="Get in touch"
        description="Questions, ideas, and project context are all welcome. We reply with a clear next step."
        crumbs={[{ label: "Home", href: "/" }, { label: "Talk to us" }]}
      />
      <Section>
        <Container>
          <div className="grid gap-8 lg:grid-cols-12">
            <Reveal className="space-y-4 lg:col-span-4" variant="left">
              <div className="rounded-3xl border border-chalk-200 bg-paper p-6 shadow-soft">
                <p className="tech-label text-signal">Other ways to reach us</p>
