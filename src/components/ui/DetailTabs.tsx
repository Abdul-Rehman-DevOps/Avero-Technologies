...
export function DetailTabs({ tabs, eyebrow = "Engagement detail" }: DetailTabsProps) {
  ...
  return (
    <div className="overflow-hidden rounded-3xl border border-chalk-200 bg-paper shadow-soft">
      <div className="border-b border-chalk-200 bg-chalk-50/90 px-4 pt-4 sm:px-5">
      ...
      >
        ...
        <div className="relative grid gap-6 p-6 md:grid-cols-12 md:p-8">
          <div className="rounded-2xl bg-paper/85 p-5 shadow-soft backdrop-blur-sm md:col-span-4 md:p-6">
          ...
          <div className="rounded-2xl bg-paper/88 p-5 shadow-soft backdrop-blur-sm md:col-span-8 md:p-6">
